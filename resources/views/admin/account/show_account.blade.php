            ...
            <table class="table table-borderless table-striped table-vcenter">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center font-size-sm">
                            <a class="font-w600" href="be_pages_ecom_product_edit.html">
                            <img src="public/upload/{{$item->image}}" class="img-fluid " alt="" style="width: 60px">
                            </a>
                        </td>
                        <td class="text-center font-size-sm">
                            <a class="font-w600" href="be_pages_ecom_product_edit.html">
                        ...
                        <a class="btn btn-sm btn-alt-secondary js-tooltip-enabled" href="edit-account/{{$item->id}}" data-toggle="tooltip" title="" data-original-title="View">
                                <i class="fa fa-fw fa-eye"></i>
                            </a>
                            <a class="btn btn-sm btn-alt-warning js-tooltip-enabled" href="change-password/{{$item->id}}" data-toggle="tooltip" title="" data-original-title="Change Password">
                                <i class="fa fa-fw fa-key"></i>
                            </a>
                        <a class="btn btn-sm btn-alt-danger js-tooltip-enabled" href="delete-account/{{$item->id}}" data-toggle="tooltip" title="" data-original-title="Delete">
