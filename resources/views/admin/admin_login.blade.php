                                ...
                                <div class="block block-themed block-fx-shadow mb-0">
                                    ...
                                    <div class="block-content">
                                        <div class="p-sm-3 px-lg-4 py-lg-5">
                                            ...
                                            <form class="js-validation-signin" action="admin-login" method="POST" novalidate="novalidate">
                                                {{ csrf_field() }}
                                                <div class="py-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="txtUser" placeholder="Username">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="password" class="form-control form-control-alt form-control-lg" id="login-password" name="txtPassword" placeholder="Password">
                                                    </div>
                                                    <div class="form-group">
