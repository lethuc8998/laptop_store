                                    ...
                                    <div class="block-content">
                                        ...
                                        <ul class="nav-items mb-0">
                                            <li>
                                                <a class="media py-2" href="javascript:void(0)">
                                                    <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                        <img class="img-avatar img-avatar48" src="public/assets/media/avatars/avatar7.jpg" alt="">
                                            ...
                                            <li>
                                                <a class="media py-2" href="javascript:void(0)">
                                                    <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                        <img class="img-avatar img-avatar48" src="public/assets/media/avatars/avatar14.jpg" alt="">
                                                        <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <a class="media py-2" href="javascript:void(0)">
                                                    <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                        <img class="img-avatar img-avatar48" src="public/assets/media/avatars/avatar6.jpg" alt="">
                                                        <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <a class="media py-2" href="javascript:void(0)">
                                                    <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                        <img class="img-avatar img-avatar48" src="public/assets/media/avatars/avatar4.jpg" alt="">
                                            ...
                                            <li>
                                                <a class="media py-2" href="javascript:void(0)">
                                                    <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                        <img class="img-avatar img-avatar48" src="public/assets/media/avatars/avatar9.jpg" alt="">
                                                        <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-warning"></span>
                                                    </div>
                                                    <div class="media-body">
                    ...
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="show-category">
                                        <span class="nav-main-link-name">Show</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="add-category">
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="show-product">
                                        <span class="nav-main-link-name">Show</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="add-product">
                                        <span class="nav-main-link-name">Add</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="show-order">
                                        <span class="nav-main-link-name">All</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="show-order-waiting">
                                        <span class="nav-main-link-name">Waiting Order</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="show-order-accepted">
                                        <span class="nav-main-link-name">Accepted Order</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="show-order-refused">
                                        <span class="nav-main-link-name">Refused Order</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="show-account">
                                        <span class="nav-main-link-name">Show Account</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="add-account">
            ...
            <header id="page-header">
                ...
                <div class="content-header">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <form class="d-none d-sm-inline-block" action="search-by-product" method="POST">
                            {{ csrf_field() }}
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control form-control-alt" placeholder="Search.." id="page-header-search-input2" name="input_value">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown d-inline-block ml-2">
                            ...
                            <img class="rounded" src="public/upload/{{Session::get('admin_image')}}" alt="Header Avatar" style="width: 18px;">
                                <span class="d-none d-sm-inline-block ml-1">{{Session::get('admin_name')}}</span>
                                <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                                <div class="p-3 text-center bg-primary">
                                    <img class="img-avatar img-avatar48 img-avatar-thumb" src="public/upload/{{Session::get('admin_image')}}" alt="">
                                </div>
                                <div class="p-2">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="logout-admin">
                                        <span>Log Out</span>
