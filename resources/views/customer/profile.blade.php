                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">                    
                            ...
                            <div class="block">
                                ...
                                z-index: 10;
                                color: #35c035fa;
                                /* transform: translateZ(501px); */
                                background: #00ffe736;
                                padding: 5px 41px;">{{Session::get('message')}}</div>
                                ...
                                <div class="block-content">
                                    ...
                                    <!-- All Products Table -->
                                                ...
                                                <div class="row justify-content-center">
                                                    ...
                                                    <form action="update-profile" method="POST" data-select2-id="10">
                                                            {{ csrf_field() }}
                                                            <div class="form-group">
                                                                <label for="one-ecom-product-name">Full Name</label>
                                                                <textarea  type="text" style="resize:none" rows="1" class="form-control" id="one-ecom-product-name" name="name">{{$customer_info->name}}</textarea>
                                                            </div>
                                                            <div class="form-group ">
                                                                <label for="one-ecom-product-description-short"> Telephone Number</label>
                                                            <input type="text"  class="form-control" id="one-ecom-product-description-short" name="phone" value={{$customer_info->phone}}>
                                                            </div>
                                                            <div class="form-group ">
                                                                <label for="one-ecom-product-description-short"> Email</label>
                                                                <input type="text"  class="form-control" id="one-ecom-product-description-short" name="email" value={{$customer_info->email}}>
                                                            </div>
                                                            <div class="form-group ">
                                                                <label for="one-ecom-product-description-short"> Address</label>
                                                            <textarea style="resize:none"  rows="1"  class="form-control" id="one-ecom-product-description-short" name="address" >{{$customer_info->address}}</textarea>
