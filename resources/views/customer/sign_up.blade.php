...
<body>
                            ...
                            <div class="block block-themed block-fx-shadow mb-0">
                                <div class="block-header bg-success">
                                    ...
                                    <div class="block-options">
                                        ...
                                        <a class="btn-block-option js-tooltip-enabled" href="op_auth_signin.html" data-toggle="tooltip" data-placement="left" title="" data-original-title="Sign In">
                                ...
                                <div class="block-content">
                                    <div class="p-sm-3 px-lg-4 py-lg-5">
                                        ...
                                        <form class="js-validation-signup" action="sign-up" method="post" novalidate="novalidate">
                                            {{ csrf_field() }}
                                            <div class="py-3">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-lg form-control-alt" id="signup-username" name="username" placeholder="Username" value={{ old('username') }}>
                                                    <div class="text-danger font-size-h6"> {!!$errors->first('username')!!}</div>
                                                </div>
                                                <div class="form-group">
                                                    <input type="password" class="form-control form-control-lg form-control-alt" id="signup-password" name="password" placeholder="Password" value={{ old('password') }}>
                                                    <div class="text-danger font-size-h6"> {!!$errors->first('password')!!}</div>
                                                </div>
                                                <div class="form-group">
                                                    <input type="password" class="form-control form-control-lg form-control-alt" id="signup-password-confirm" name="re_password" placeholder="Password Confirm">
                                                    <div class="text-danger font-size-h6"> {!!$errors->first('re_password')!!}</div>
                                                </div>
                                                <div class="form-group">
    ...
    <!-- Page JS Code -->
    <script src="public/assets/js/pages/op_auth_signup.min.js"></script>
