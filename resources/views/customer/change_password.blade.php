                    ...
                    <div class="col-md-8">                    
                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    ...
                                    <!-- All Products Table -->
                                    @if (Session('message'))
                                    <div id="change-password" style="position: fixed;
                                    top: 20%;
                                    left: 43%;
                                    z-index: 5;
                                    /* height: 200px; */
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <form action="change-password-customer" method="POST" data-select2-id="10">
                                            {{csrf_field()}}
                                            <div class="form-group">
                                                <label for="one-ecom-product-name">Username</label>
                                                <textarea readonly type="text" style="resize:none" rows="1" class="form-control" id="one-ecom-product-name" >{{$customer->username}}</textarea>
                                            </div>
                                            <div class="form-group ">
