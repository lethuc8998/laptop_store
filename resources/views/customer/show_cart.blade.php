                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <?php $product=Cart::content() ?>
                            ...
                            <div class="block">
                                ...
                                <div class="block-content block-content-full">
                                    <table class="table table-borderless table-hover table-vcenter">
                                        <thead>
                                            <tr class="text-center text-info font-size-h5 font-weight-bold">
                                                <td >Action</td>
                                                <td >Image</td>
                                                <td>Product</td>
                                                <td>Quanlity</td>
                                        ...
                                        <tbody class="text-center text-success">
                                            ...
                                            <tr>
                                                <td >
                                                <a class="text-danger" href="delete-one-row/{{$item->rowId}}"><i class="fa fa-times"></i></a>
                                                </td>
                                                <td style="width: 100px;">
                                                <img class="img-fluid" src="public/upload/{{$item->options->image}}" alt="">
                                                </td>
                                                <td>
                                                <a class="h5 text-left" href="be_pages_ecom_store_product.html" >{{$item->name}}</a>
                                            
                                                </td>
                                                <td >
                                                    <form action="update-product-qty" method="POST">
                                                        {{ csrf_field() }}
                                                        <input type="hidden" name="rowId" value={{$item->rowId}}>
                                                        <div class="font-w600 " style="margin-top: 15px;">
                                                            <span class="text-center ">
                                                                <input style="padding:5px; border:none; width:35px;" type="text" value= {{$item->qty}} name="qty">
                                                            </span>
                                                            <span class="text-right mr-2"><button class="text-info border-0" type="submit"><i class="fa fa-shopping-bag" aria-hidden="true"></i></button></span>
                                                        </div>
                                                    </form>
                                                </td>
                                                <td >
                                                    <div class="font-w600 ">{{'$ '.$item->price}}</div>
                                                </td >
                                            <td><div class="font-w600 ">{{'$ '.$item->qty*$item->price}}</div></td>
                                            </tr>
                            ...
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">2. Please Write Your Information Below</h3>
                                </div>
                                <div class="block-content block-content-full">
                                        <form action="create-order" method="POST">
                                            {{ csrf_field() }}
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="checkout-username">Your Full Name</label>
                                                            @if($customer->name!=null)
                                                            <textarea readonly class="form-control form-control-alt" id="checkout-username" name="name" style="resize: none" rows="1" >{{$customer->name}}</textarea>
                                                            @else
                                                            <textarea  class="form-control form-control-alt" id="checkout-username" name="name" style="resize: none" rows="1" ></textarea>
                                                            @endif
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input readonly type="text" class="form-control form-control-alt" id="checkout-email" name="phone" value={{$customer->phone}}>
                                                            @else
                                                            <input type="text" class="form-control form-control-alt" id="checkout-email" name="phone" >
                                                            @endif
                                                            <div class="text-danger font-size-h6"> {!!$errors->first('phone')!!}</div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="checkout-password-confirm">Email</label>
                                                            @if ($customer->email!=null)
                                                            <input readonly type="email" class="form-control form-control-alt" id="checkout-password-confirm" name="email" value={{$customer->email}}>
                                                            @else
                                                            <input type="email" class="form-control form-control-alt" id="checkout-password-confirm" name="email" >
                                                            @endif
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="checkout-lastname">Address</label>
                                                            @if ($customer->address!=null)
                                                            <textarea readonly style="resize: none" rows="1" class="form-control form-control-alt" id="checkout-lastname" name="address" >{{$customer->address}}</textarea> 
                                                            @else
                                                            <textarea  style="resize: none" rows="1" class="form-control form-control-alt" id="checkout-lastname" name="address" ></textarea>
                                                            @endif
                                                            <div class="text-danger font-size-h6"> {!!$errors->first('address')!!}</div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="checkout-firstname">Notes</label>
                                                            <input type="text" class="form-control form-control-alt" id="checkout-firstname" name="notes">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label for="checkout-lastname">Your Emotion</label>
                                                            <input type="text" class="form-control form-control-alt" id="checkout-lastname" name="emotion">
                                                        </div>
                                                    </div>   
                                                    </div>
